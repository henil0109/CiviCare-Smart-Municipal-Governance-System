            ...
            <div className="relative z-10 flex-1 flex items-center justify-center p-4 py-24">
                {success ? (
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col relative bg-slate-950/60">
                            {/* Scrollable step content */}
                            <div className="flex-1 overflow-y-auto custom-scrollbar p-8 md:p-12 pb-6">
                            ...
                            {/* Navigation Buttons — always visible at bottom, no overlap */}
                            <div className="flex justify-between items-center px-8 md:px-12 py-4 border-t border-white/10 bg-slate-950/80 backdrop-blur-sm">
                                {step > 1 ? (
