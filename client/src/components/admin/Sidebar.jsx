            ...
            >
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 border-t border-slate-100 bg-white">
                    ...
                    <div className="mt-6 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white text-sm font-bold uppercase shadow-sm">
